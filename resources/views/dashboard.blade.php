                ...
                <div class="flex flex-col space-y-8 bg-gray-700 w-4/12 p-4">
                    ...
                    <div class="flex justify-between w-full">
                        <div class="flex items-center space-x-4">
                            <span class="text-lg font-bold text-white" x-text="'Inbox (' + messages.length + ')'"></span>
                            <svg @click="fetchMessages"
                                 class="h-4 w-4 hover:opacity-60 transition cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
